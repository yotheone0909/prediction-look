export default function CardMatch({ sport }) {
    return (
        <div className="flex-1 basis-1/4">
            <div className="max-w-sm rounded overflow-hidden shadow-lg m-4">
                ...
                <div className="px-6 py-4">
                    <div className="font-bold text-xl mb-2">{sport.matchName}</div>

                    <div className="flex">
                        <p>{sport.timeLock}Close Prediction : 10D 5H 20M 10S</p>
                    </div>

                    <div className="flex justify-between mb-1">
                        <span className="text-base font-medium text-blue-700">Home</span>
                        <span className="text-sm font-medium text-blue-700 ">{sport.homePercentage}</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: sport.homePercentage }}></div>
                    </div>

                    <div className="flex justify-between mb-1">
                        <span className="text-base font-medium text-blue-700">Draw</span>
                        <span className="text-sm font-medium text-blue-700">{sport.drawPercentage}</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div className="bg-orange-500 h-2.5 rounded-full" style={{ width: sport.drawPercentage }}></div>
                    </div>

                    <div className="flex justify-between mb-1">
                        <span className="text-base font-medium text-blue-700 ">Away</span>
                        <span className="text-sm font-medium text-blue-700 ">{sport.awayPercentage}</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div className="bg-red-600 h-2.5 rounded-full" style={{ width: sport.awayPercentage }}></div>
                    </div>
